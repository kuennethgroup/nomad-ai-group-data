...
- Dynamic Explore dashboards are not generated by the parser yet. Column mode
  is best for native table import and entry-level plots; row mode is best when
  each spreadsheet row should be searchable/visualizable as its own NOMAD entry.

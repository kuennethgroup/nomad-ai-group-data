...
SYSTEM_PROMPT = (
    ...
    'If a column header is just an uncertainty marker with no meaning of its own '
    '(e.g. "+/-", "Error", "Std Dev"), it belongs to the column immediately before '
    'it: give it "category": "uncertainty", "guessed_name" "<that column>_uncertainty", '
    'and reuse that column\'s unit unless the header has its own. '
